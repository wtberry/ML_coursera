...
hidden_layer_size = 1000 # hidden units
...
results = minimize(fun.CostFunction, x0=r_nn_params, args=myargs, options={'disp': True, 'maxiter':maxiter}, method=mymethod, jac=True)
nn_params = results['x']
...
prediction = fun.predict(theta1, theta2, X)
accuracy = ac.accuracy(prediction, y)

print('Training set accuracy: \n', accuracy, '%')

### Testing set Prediction ###
prediction_test = fun.predict(theta1, theta2, Xt)
accuracy_test = ac.accuracy(prediction_test, yt)
